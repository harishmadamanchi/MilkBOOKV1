...
const AddSupplierScreen = props => {
    ...
    const enteredSupplierNameHandler = (enteredName) => {
        setSupplierName(enteredName);
    }
    ...
    const DispatchAddSupplier = async () => {
    ...
    // For instance, get the download URL: https://firebasestorage.googleapis.com/...
            ...
            firebase.database().ref('Supplier/'+mobileNumber).set({
                SupplierImage : downloadURL,
                SupplierName : supplierName,
                SupplierMobile : mobileNumber,
                SupplierAddress : Address
            }).then(() => {
                console.log('Supplier Inserted');
                dispatch(supplierActions.addSupplier(newSupplier)).then(()=>{
                    ...
                    Alert.alert(
                        ...
                        [
                          { text: 'OK', onPress: () => {
                                ...
                                setAddress(null);setImagePicked(null);setMobileNumber(null);setSupplierName(null);
    ...
    return (
        <View style = {Styles.Container}>
            ...
            <View style = {Styles.dataContainer}>
                ...
                placeholder = 'Supplier Name' onChangeText = {enteredSupplierNameHandler}
                value = { supplierName }/>
                <TextInput style = {Styles.editBox} 
            ...
            <TouchableOpacity style={Styles.buttoncontainer} onPress = {DispatchAddSupplier}>
...
AddSupplierScreen.navigationOptions = navData => {
    return {
        headerTitle : () => (
            <Image 
            resizeMode = 'cover'
